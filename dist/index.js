(function (global, factory) {
  ...
  focusManager.handleFocus;
  focusManager.markForFocusLater;
  focusManager.returnFocus;
  focusManager.popWithoutFocus;
  focusManager.setupScopedFocus;
  ...
  */
  ...
  safeHTMLElement.SafeNodeList;
  safeHTMLElement.SafeHTMLCollection;
  ...
  ariaAppHider.assertNodeList;
  ariaAppHider.setElement;
  ariaAppHider.validateElement;
  ariaAppHider.hide;
  ariaAppHider.show;
  ...
  Modal_1.bodyOpenClassName;
  Modal_1.portalClassName;
  ...
  var dist = Autosuggest_1["default"];
  ...
  function formatSuggestions(filteredSuggestions) {
    return filteredSuggestions.map(function (suggestion) {
      ...
      return _objectSpread2(_objectSpread2({}, opts), suggestion.obj);
    });
  }
  ...
  var getSuggestions = function getSuggestions(unfilteredSearch, allCommands, options, filterSearchQuery, showAllCommandsWhenNoneMatches) {
    var search = filterFuzzySortSearch(unfilteredSearch, filterSearchQuery); // TODO: preparing fuzzysort results make them much faster
    ...
    var suggestionResults = fuzzysort.go(search, allCommands, options);
  ...
  var CommandPalette = /*#__PURE__*/function (_React$Component) {
    _inherits(CommandPalette, _React$Component);
    ...
    function CommandPalette(props) {
      ...
      _this.onSuggestionHighlighted = _this.onSuggestionHighlighted.bind(_assertThisInitialized(_this));
      ...
      _this.commandTemplate = _this.commandTemplate.bind(_assertThisInitialized(_this));
      _this.renderModalCommandPalette = _this.renderModalCommandPalette.bind(_assertThisInitialized(_this));
      _this.renderInlineCommandPalette = _this.renderInlineCommandPalette.bind(_assertThisInitialized(_this));
    ...
    _createClass(CommandPalette, [{
      ...
      value: function onSuggestionsFetchRequested(_ref4) {
        ...
        var _this$props3 = this.props,
            ...
            filterSearchQuery = _this$props3.filterSearchQuery,
            showAllCommandsWhenNoneMatches = _this$props3.showAllCommandsWhenNoneMatches;
        this.setState({
      ...
      value: function focusInput() {
        ...
        mousetrap(this.commandPaletteInput.input).bind(["esc"].concat(hotKeys), this.handleCloseModal);
      }
    }, {
      key: "handleOpenModal",
      value: function handleOpenModal() {
        var _this$props5 = this.props,
            resetInputOnOpen = _this$props5.resetInputOnOpen,
      ...
      value: function commandTemplate(suggestion) {
        return /*#__PURE__*/React__default["default"].createElement(RenderCommand, Object.assign({}, this.props, {
          suggestion: suggestion
        }));
      ...
      value: function renderAutoSuggest() {
        ...
        var _this$props7 = this.props,
            maxDisplayed = _this$props7.maxDisplayed,
            spinner = _this$props7.spinner,
            showSpinnerOnSelect = _this$props7.showSpinnerOnSelect,
            display = _this$props7.display,
            header = _this$props7.header,
            highlightFirstSuggestion = _this$props7.highlightFirstSuggestion,
            alwaysRenderCommands = _this$props7.alwaysRenderCommands;
        ...
        return /*#__PURE__*/React__default["default"].createElement("div", null, /*#__PURE__*/React__default["default"].createElement(Header, {
          theme: theme
        }, header), /*#__PURE__*/React__default["default"].createElement(dist, {
      ...
      value: function renderModalCommandPalette() {
        ...
        var _this$props8 = this.props,
            ...
            reactModalParentSelector = _this$props8.reactModalParentSelector,
            shouldReturnFocusAfterClose = _this$props8.shouldReturnFocusAfterClose;
        return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  CommandPalette.defaultProps = {
    ...
    filterSearchQuery: function filterSearchQuery(inputValue) {
      return inputValue;
    },
    onChange: noop,
    onHighlight: noop,
